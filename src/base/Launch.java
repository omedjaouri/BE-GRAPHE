...
public class Launch {
	...
	public void afficherMenu () {
		...
		System.out.println("7 - Covoiturage ");
		System.out.println () ;
	}
	...
	public void go() {
		...
		try {
			...
			while (continuer) {
				...
				case 6 : algo = new DijkstraTests(graphe, this.fichierSortie(), this.readarg); break;
				
				case 7 : algo = new Covoiturage(graphe, this.fichierSortie(), this.readarg); break;
